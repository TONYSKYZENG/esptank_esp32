...
#define GPIO_EN_PIN_SEL  ((1ULL<<18)|(1ULL<<5))
#include "driver/gpio.h"
#include "motor.h"
extern void i2s_music(void *args);
void initGpio()
{
...
extern void  i2s_music_mp3(void *args);
...
static void tcp_server_task(void *pvParameters)
{
   ...
   // playMusicLoop(mp3_data_start_idel,mp3_data_end_idel);
    //playMusicSingle(mp3_data_start_connected,mp3_data_end_connected);
    playMusicLoop(mp3_data_start_idel,mp3_data_end_idel);
