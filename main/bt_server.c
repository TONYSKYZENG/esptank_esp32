...
static const char local_device_name[] = "ESP_T72`";
...
static void esp_spp_cb(esp_spp_cb_event_t event, esp_spp_cb_param_t *param)
{
    ...
    case ESP_SPP_DATA_IND_EVT:
         ...
         */
        ESP_LOGI(SPP_TAG, "ESP_SPP_DATA_IND_EVT len:%s handle:%"PRIu32,
                 param->data_ind.data, param->data_ind.handle);
        char *str = (char *)param->data_ind.data;
        paraseInput((char*)param->data_ind.data,param);
